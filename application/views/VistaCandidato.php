    ...
    <header id="header" class="fixed-top d-flex ">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a style="color: #F5F5F5; font-family:Cuprum, sans-serif; font-size: 18px" class="nav-link nv" href="<?php echo base_url("index.php/Control/PublicacionesV"); ?>">Regresar</a></li>
    ...
    <section id="services" class="services section-bg">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-down">
                <br><br>
                <h2 style="font-family: Cuprum, sans-serif;">¡Encuentra la oportunidad que mas se adapte a tus habilidades!</h2>
                <p></p>
            </div>

            <div class="row">

                <?php foreach ($VistaCandidato as $datos) { ?>
                    <div class="col-lg-4 mb-5" data-aos="flip-right">
                        <div class="icon-box icon-box-cyan">
                            <div class="icon">
                                <img class="center" data-bss-hover-animate="rubberBand" width="270px" height="170px" src="<?php echo base_url(''); ?>logEmpresa/<?php echo $datos->foto_emp ?>">
                                <br><br>
                            </div>
                            <h4 style="background:#EABE3F;text-align:center;box-shadow:3px -4px 3px 1px;font-family: Cuprum, sans-serif" id="nombre" name="nombre">
                                <font color="black"><?php echo $datos->nombre ?></font>
                            </h4>
                            <div align="left">
                                <strong>
                                ...
                                <em>
                                    <font><?php echo $datos->representante ?></font>
                                </em><br>
                                <strong>
                                    <i class="bi bi-telephone-fill"></i>
                                </strong>&nbsp;
                                <em>
                                    <font><?php echo $datos->telefono ?></font>
                                </em><br>
                                <strong>
                                    <i class="bi bi-envelope-fill"></i>
                                </strong>&nbsp;
                                <em>
                                    <font><?php echo $datos->correo_emp ?></font>
                                </em>
                            </div>
                            <a class="btn shadow btn-xl rounded-pill mt-3" role="button" data-bss-hover-animate="tada" href="<?php echo base_url('') ?>index.php/Control/Vacantes/<?php echo $datos->idempresa; ?>" style="background: #000;width: auto;">
                                <font color="white">Vacantes publicadas</font>
                            </a>
                        </div>
                    </div>
                <?php } ?>
