    ...
    <header id="header" class="fixed-top d-flex ">
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a style="color: #F5F5F5; font-family:Cuprum, sans-serif; font-size: 18px" class="nav-link nv" href="<?php echo base_url("index.php/Control"); ?>">Regresar</a></li>
    ...
    <section id="services" class="services section-bg">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-down">
                <br><br>
                <h2 style="font-family: Cuprum, sans-serif;">¡Selecciona el tipo de perfil que necesitas para tu empresa!</h2>
                <p></p>
            </div>
            <div class="row">
                <?php foreach ($VistaEmpresa as $datos) { ?>
                    <div class="col-lg-4 mb-4" data-aos="flip-right">
                        <div class="icon-box icon-box-cyan" style="height:31em;">
                            <div class="icon">
                                <a href="">
                                    <img data-bss-hover-animate="rubberBand" height="180px" width="170px" src="<?php echo base_url(''); ?>imgCateg/<?php echo $datos->img ?>">
                                </a><br><br>
                            </div>
                            <h4 style="background:#EABE3F;text-align:center;box-shadow:3px -4px 3px 1px;font-family: Cuprum, sans-serif" id="nombre" name="nombre">
                                <font color="black"><?php echo $datos->n_categoria ?></font>
                            </h4>
                            <div style="text-align:justify">
                                <em>
                                    <font><?php echo $datos->descripcion ?></font>
                                </em>
                            </div>
                            <a class="btn shadow btn-xl rounded-pill mt-3" style="background: #000;width: auto" role="button" data-bss-hover-animate="tada" href="<?php echo base_url('') ?>index.php/Control/VistaPerfilesCateg/<?php echo $datos->idcategoria; ?>">
                                <font color="white">Ver perfiles</font>
                            </a>
                        </div>
                    </div>
                <?php } ?>
